  ...
  ##################################
    ...
    for(t in 1:table_no){
      ...
      if(my_table[[t]]$result_type[1] =="time"){
        ...
        # I the error with the World Champs tables is here. 
        # There is no time entry in some of the 'non-points' tables and this causes an issue
        # Having NULL values is an issue for the lubridate functions (I think....)
